...
<div class="user_hint">
    ...
    <ol>
        <li>
            <b>با توجه به شیوع بیماری کرونا و عید نوروز، تمامی سفارش‌ها پس از تعطیلات عید نوروز آماده و ارسال خواهند شد.
            </b>
        </li>
        <li>
...
<div class="user_hint">
    ...
    <ol>
        ...
        <li>
            پست سفارشی:<br>
            در این روش، مرسوله از طریق زمینی ارسال خواهد شد. زمان تحویل مرسوله،2 الی 5 روز پس از ارسال است. هزینه این روش، 12000 تومان است.
        </li>
        <li>
            پست پیشتاز:<br>
            در این روش، مرسوله از طریق هوایی ارسال خواهد شد. زمان تحویل مرسوله، 1 الی 2 روز پس از ارسال است. هزینه این روش، 16000 تومان است.
        </li>
    </ol>
</div>
<?php
...
<?php
if($_SESSION["cart"]->has_category("پکیج ولنتاین") > 0 && $_SESSION["address"]->data()["county"] != "شهر تهران"){
}else{
