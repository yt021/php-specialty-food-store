                    ...
                    $data["invoiceDate"] == $bcd["invoiceDate"]){
                        ...
                        $bcd["terminalCode"] == $terminal_code){
                            ...
                            if($bcd["amount"] == $amount){
                                ...
                                $day_id=0;
                                if(isset($_SESSION["send_date"]) && var_exist($_SESSION["send_date"]->day_id,"send_date","id")){
                                    $day_id=$_SESSION["send_date"]->day_id;
                                }
                                $tref_id = $bcd['transactionReferenceID'];
                                $trace_no = $bcd['traceNumber'];
                                $ref_no = $bcd['referenceNumber'];
                                
                                if(db_pay_order_pep($oid,$tref_id,$trace_no,$ref_no,$day_id=0)){
