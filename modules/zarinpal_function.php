...
// 		return (extension_loaded('soap')) ? true : false;
	...
	public function request($MerchantID, $Amount, $Description="", $Email="", $Mobile="", $CallbackURL, $SandBox=false, $ZarinGate=false)
	{
		if(!defined('EXTERNAL_INTEGRATIONS_ENABLED') || !EXTERNAL_INTEGRATIONS_ENABLED) {
			return array("Status" => 0, "Message" => "Payment disabled in showcase mode", "StartPay" => "", "Authority" => "");
		}
	...
	{
		if(!defined('EXTERNAL_INTEGRATIONS_ENABLED') || !EXTERNAL_INTEGRATIONS_ENABLED) {
			return array("Status" => 0, "Message" => "Payment disabled in showcase mode", "Amount" => $Amount, "RefID" => "", "Authority" => "");
		}
		$ZarinGate = ($SandBox == true) ? false : $ZarinGate;
